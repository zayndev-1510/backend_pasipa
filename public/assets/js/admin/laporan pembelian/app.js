...
app.controller("homeController", function($scope, service) {
    ...
    fun.cetakLaporan = () => {
        var datalaporan = [];
        if (aksi == 0) {
            datalaporan = fun.produkmasuk
        } else if (aksi == 1) {
            datalaporan = fun.produkmasukbulanan;
        } else if (aksi == 2) {
            datalaporan = fun.produkmasuktahunan
        }
        ...
        window.location.href = "http://localhost:8000/admin/cetak-laporan-pembelian";
    }
    fun.DataProdukMasuk();
