...
<head>
    ...
    <title>POS SMART SWALAYAN</title>
    ...
    <!-- amchart css -->
    <link rel="stylesheet" href="https://www.amch
    arts.com/lib/3/plugins/export/export.css" type="text/css"
        media="all" />
    <!-- others css -->
        ...
        <div class="sidebar-menu" style="background-color: #483D8B;color:white;">
            <div class="sidebar-header" style="background-color: #483D8B;color:white;">
                <div class="logo">
                    ...
                    <p style="color: white;font-weight: bolder;">POS SMART SWALAYAN</p>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li>
                                        <a href="{{ url('admin/dashboard/kasir') }}">
                                            <i class="ti-user"></i>
                                            <span>Kasir</span></a>
                                    </li>
                                    <li><a href="{{ url('admin/dashboard/suplier') }}">
                                            <i class="ti-book" aria-hidden="true"></i>
                                            <span>Suplier</span></a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i
                                        class="ti-layout-sidebar-left"></i><span>Data Pembelian
                                    </span></a>
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('admin/dashboard/produk-masuk')}}">
                                            <i class="ti-rss"></i>
                                            <span>Produk Hari ini</span></a>
                                    </li>
                                      <li>
                                        <a href="{{ url('admin/dashboard/riwayat-pembelian')}}">
                                            <i class="ti-rss"></i>
                            ...
                            <li>
                                <a href="#" aria-expanded="true"><i class="ti-calendar"></i><span> Data Penjualan
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="{{ url('admin/dashboard/transaksi/today') }}">
                                        <i class="ti-user" aria-hidden="true"></i>
                                        <span>Penjualan Hari Ini</span></a></li>
                                <li>
                                    <li><a href="{{ url('admin/dashboard/riwayat-penjualan') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                            ...
                            <li>
                                <a href="#" aria-expanded="true"><i class="ti-calendar"></i><span> Data Laporan
                                    </span></a>
                                <ul class="collapse">

                                    <li>
                                        <a href="{{ url('admin/perkuliahan') }}" aria-expanded="true">
                                            <i class="ti-user"></i><span> Produk Masuk </span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('admin/khs') }}" aria-expanded="true">
                                            <i class="ti-user"></i><span> Produk Keluar </span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('admin/pengajar') }}" aria-expanded="true">
                                            <i class="ti-user"></i><span> Transaksi </span></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
