            ...
            <div class="col-12 mt-0 content-tab">
                <div class="card">
                    <div class="card-body" id="tabel-toko">
                        <h5>Pembelian Produk Keseluruhan</h5>
                        <hr></hr>
                        <div class="data-tab">
...
@section('javascript')
    ...
    <script src="{{ asset('assets/js/admin/riwayat pembelian/app.js') }}"></script>
    <script src="{{ asset('assets/js/admin/riwayat pembelian/service.js') }}"></script>
@endsection
